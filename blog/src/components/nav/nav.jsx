...
export default function Nav() {
    ...
    const navList = (
        <ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6 text-slate-400">
            <NavLink to="/">
                <Typography
                    as="li"
                    variant="small"
                    color="blue-gray"
                    className="flex items-center gap-x-2 p-1 font-medium hover:text-slate-200 transition-all transition-ease transition-duration-100"
                >
                    <svg
                        width="16"
                        height="15"
            ...
            <Typography
                ...
                variant="small"
                color="NavIcons"
                className="flex items-center gap-x-2 p-1 font-medium cursor-pointer  hover:text-slate-200 transition-all transition-ease transition-duration-100"
    ...
    return (
        <Navbar className="mx-auto max-4 py-2 lg:px-8 lg:py-4 bg-gray-800 w-full rounded-none border-none sticky top-0  h-14 flex items-center">
            <div className="container mx-auto flex flex-wrap items-center justify-between ">
                <NavLink to="/">
                    <Typography className="mr-4 cursor-pointer py-1.5 font-medium text-2xl">
                        <span className="text-green-400 font-bold">B</span><span className="text-slate-300">logs</span>
                    </Typography>
                </NavLink>
